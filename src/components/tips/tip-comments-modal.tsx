...
import { CommentResponseDto, CommunityTipResponseDto } from '@/types/api-models';
...
interface TipCommentsModalProps {
    tip: TipCommentsTarget;
    onClose: () => void;
}

type TipCommentsTarget = Pick<CommunityTipResponseDto, 'id' | 'type' | 'title'> & {
    _count?: {
        comments?: number;
    };
};
            ...
            >
                ...
                <div className="px-6 py-4 md:px-8 md:pt-8 md:pb-6 border-b border-border flex items-center justify-between bg-black/20">
                    <div className="flex items-center gap-3 text-white">
                        <MessageSquare
                            size={20}
                            className={tip.type === 'AVOID' ? 'text-red-400' : 'text-emerald-400'}
                        />
