...
export function TipCard({
    ...
    const createdAtLabel = tip.createdAt ? new Date(tip.createdAt).toLocaleDateString() : '';
        ...
        >
            ...
            <div className="hidden md:flex items-center gap-4 relative z-10">
                ...
                >
                    ...
                    <span className="transition-colors duration-200">{tip.voteCount || 0}</span>
                </button>
            ...
            <div className="md:hidden flex gap-3 pt-4 border-t border-white/10 relative z-10">
                ...
                >
                    ...
                    <span className="transition-colors duration-200">{tip.commentCount || 0}</span>
                </button>
