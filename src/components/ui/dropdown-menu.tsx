    ...
    <DropdownMenuContext.Provider value={{ close }}>
      <div className={cn("relative inline-block text-left", className)} ref={menuRef}>
        ...
        {isOpen && (
          <div 
            className={cn(
              "absolute z-50 mt-2 min-w-[160px] bg-gray-950/95 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200",
...
export function DropdownMenuItem({ children, onClick, className, danger, asChild }: DropdownMenuItemProps) {
