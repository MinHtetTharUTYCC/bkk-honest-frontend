...
export function useProfile(id: string) {
  const query = useProfilesControllerFindOne(id, {
...
export function useInfiniteUserPriceReports(userId: string) {
  ...
  const myReports = usePriceReportsControllerFindMyReportsInfinite(
    { take: 10 },
    {
      query: {
  ...
  const userReports = usePriceReportsControllerFindByUserInfinite(
    userId,
    { take: 10 },
    {
      query: {
...
export function useInfiniteUserScamAlerts(userId: string) {
  const isMe = userId === "me";
  const myAlerts = useScamAlertsControllerFindMyAlertsInfinite(
    { take: 10 },
    {
      query: {
  ...
  const userAlerts = useScamAlertsControllerFindByUserInfinite(
    userId,
    { take: 10 },
    {
      query: {
...
export function useInfiniteUserCommunityTips(userId: string) {
  const isMe = userId === "me";
  const myTips = useCommunityTipsControllerFindMyTipsInfinite(
    { take: 10 },
    {
      query: {
  ...
  const userTips = useCommunityTipsControllerFindByUserInfinite(
    userId,
    { take: 10 },
    {
      query: {
...
export function useInfiniteUserSpots(userId: string) {
  const isMe = userId === "me";
  const mySpots = useSpotsControllerFindMySpotsInfinite(
    { take: 10 },
    {
      query: {
  ...
  const userSpots = useSpotsControllerFindByUserInfinite(
    userId,
    { take: 10 },
    {
      query: {
