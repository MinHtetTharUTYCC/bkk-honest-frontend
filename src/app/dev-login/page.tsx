...
export default function DevLoginPage() {
  ...
  const [password, setPassword] = useState('password123'); // Default seed password
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-[40px] p-12 border border-gray-100 shadow-2xl shadow-gray-200/40 space-y-8">
        <header className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-black text-gray-900 tracking-tighter uppercase italic">Dev Portal</h1>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Authenticate as Seeded User</p>
        </header>
        ...
        <form onSubmit={handleDevLogin} className="space-y-6">
          <div className="space-y-4">
            <label className="block text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Seed Email</label>
            <input 
              type="email" 
              value={email}
          ...
          <div className="space-y-4">
            <label className="block text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Password</label>
            <input 
              type="password" 
              value={password}
