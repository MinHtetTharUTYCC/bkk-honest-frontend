                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                By accessing or using BKK Honest ("the Platform"), you agree to be
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mb-4">
                                BKK Honest is a community-driven platform where users share honest
                                reviews, experiences, and information about Thailand destinations,
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            ...
                                            do not guarantee accuracy, completeness, or reliability
                                            of any information.
                                        </p>
                                    </div>
                                    <div>
                        ...
                        <div>
                            ...
                            <div className="bg-muted/30 p-4 rounded-lg border border-border">
                                <p className="text-muted-foreground text-sm">
                                    ...
                                    disruptions, safety incidents, or negative experiences resulting
                                    from information or recommendations found on the platform.
                                </p>
                            </div>
                        </div>
