          ...
          <div className="space-y-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-2">
                    ...
                    <li>
                      • <strong>Reviews and Reports:</strong> Content you post,
                      ratings, photos, location data
                    </li>
                    <li>
                      • <strong>Communications:</strong> Messages to our support
                      team or feedback
                    </li>
                    <li>
                      • <strong>Authentication:</strong> Social media login
                      information (if you choose to connect)
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-2">
                    ...
                    <li>
                      ...
                      device type, IP address, location (if permitted)
                    </li>
                    <li>
                      • <strong>Performance Data:</strong> Error logs, loading
            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20">
                <p className="text-primary">
                  <strong>We do NOT:</strong> Sell your personal information,
                  send spam emails, or track you across other websites.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-green-500/10 p-4 rounded-lg border border-green-500/20">
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      • Your reviews, ratings, and photos you choose to post
                    </li>
              ...
              <p className="text-muted-foreground mt-4">
                We may share information with service providers (like hosting
                and analytics) who help operate our platform, but they&apos;re
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Required for the platform to work properly (login, security,
                    preferences)
                  </p>
                </div>
                <div>
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                We take your data security seriously and implement multiple
              ...
              <div className="bg-muted/30 p-6 rounded-lg border border-border">
                <ul className="text-muted-foreground space-y-2">
                  ...
                  <li>
                    • <strong>Incident Response:</strong> Rapid response plan
                    for any security issues
                  </li>
                  <li>
                    • <strong>Data Minimization:</strong> We only collect what
                    we actually need
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We may update this privacy policy occasionally. We&apos;ll
                    notify you of significant changes via email or a notice on
                    the platform. The &quot;last updated&quot; date at the top
