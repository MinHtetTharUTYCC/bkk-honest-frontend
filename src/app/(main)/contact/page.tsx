    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-white/60 max-w-md mb-8 leading-relaxed">
          ...
          Our team of honest Bangkokians will review your message and get back
          to you at <span className="text-white/90">{formData.email}</span>{" "}
          soon.
        </p>
        <button
          onClick={() => {
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-12">
      <header className="space-y-4 text-center md:text-left">
        ...
        <p className="text-white/40 text-sm md:text-base max-w-2xl leading-relaxed">
          ...
          Drop us a message below and we&apos;ll get back to you as soon as we
          can.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
        <div className="lg:col-span-3">
          <form
            ...
            className="space-y-6 bg-white/5 border border-white/10 p-6 md:p-8 rounded-3xl backdrop-blur-sm"
          >
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/40 leading-relaxed mt-1">
                    Found incorrect pricing or a scam alert that needs
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/40 leading-relaxed mt-1">
                    Want to collaborate or feature your honest local business?
                    We&apos;d love to talk.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-white/10">
                <p className="text-[10px] text-white/30 leading-relaxed italic">
                  &ldquo;Honesty is the fastest way to prevent a mistake from
                  turning into a failure.&rdquo;
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-400 p-8 rounded-3xl text-black space-y-2">
            ...
            <p className="text-sm font-medium opacity-80 leading-relaxed">
              If you are currently experiencing a scam or safety issue, please
              contact local tourist police at{" "}
              <span className="font-bold underline">1155</span>.
            </p>
          </div>
        </div>
      </div>
