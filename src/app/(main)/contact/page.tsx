                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-card p-6 rounded-lg border border-border">
                            ...
                            <p className="text-foreground/60 text-sm">
                                Use the "Report" button on any review or spot page, or contact us
                                directly with details about what needs to be corrected.
                            </p>
                        </div>
                        ...
                        <div className="bg-card p-6 rounded-lg border border-border">
                            ...
                            <p className="text-foreground/60 text-sm">
                                Our community flags suspicious content, and our moderators review
                                reports. We also use automated systems to detect fake reviews.
                            </p>
                        </div>
