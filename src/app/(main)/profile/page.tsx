...
export default function ProfilePage() {
    ...
    const activeTab =
        (searchParams.get('tab') as 'scams' | 'reports' | 'tips' | 'spots') || 'scams';
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-6">
                            {!scamsData ? (
                                ...
                                [1, 2].map((i) => (
                                    <div
                                        key={i}
                                        className="bg-card rounded-2xl p-6 border border-white/8 h-40 animate-pulse"
                                    />
                                ))
                            ) : scamsList.length > 0 ? (
                                ...
                                <div className="py-16 text-center bg-white/5 rounded-2xl border border-dashed border-white/10 flex flex-col items-center gap-4">
                                    ...
                                    <Link
                                        href="/report"
                                        className="text-xs font-bold text-red-400 hover:text-red-300 transition-colors uppercase tracking-widest flex items-center gap-1"
                                    >
                        ...
                        <div className="flex flex-col gap-6">
                            {!tipsData ? (
                                ...
                                <div className="py-20 text-center bg-white/5 rounded-2xl border border-dashed border-white/10">
                                    ...
                                    <Link
                                        href="/report"
                                        className="text-xs font-bold text-emerald-400 hover:text-emerald-300 transition-colors uppercase tracking-widest flex items-center gap-1"
                                    >
                        ...
                        <div className="flex flex-col gap-6">
                            {!reportsData ? (
                                ...
                                <div className="py-16 text-center bg-white/5 rounded-2xl border border-dashed border-white/10 flex flex-col items-center gap-4">
                                    ...
                                    <Link
                                        href="/report"
                                        className="text-xs font-bold text-amber-400 hover:text-amber-300 transition-colors uppercase tracking-widest flex items-center gap-1"
                                    >
                        ...
                        <div className="flex flex-col gap-6">
                            {!spotsData ? (
                                ...
                                <div className="py-16 text-center bg-white/5 rounded-2xl border border-dashed border-white/10 flex flex-col items-center gap-4">
                                    ...
                                    <Link
                                        href="/report"
                                        className="text-xs font-bold text-orange-400 hover:text-orange-300 transition-colors uppercase tracking-widest flex items-center gap-1"
                                    >
                    ...
                    <div ref={ref} className="py-10 flex justify-center">
                        ...
                        {!hasNextReports && activeTab === 'reports' && reportsList.length > 0 && (
                            <p className="text-[10px] font-medium uppercase tracking-widest text-white/20">
                                End of price pulse
                            </p>
                        )}
