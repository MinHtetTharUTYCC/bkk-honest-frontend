                ...
                <div className="relative max-w-7xl mx-auto px-4 py-24">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-amber-100 max-w-3xl mx-auto leading-relaxed">
                            Discover authentic Thailand through community-driven reviews, real-time
                            alerts, and honest recommendations from fellow travelers and locals.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-muted-foreground">
                                Share your own experiences by submitting reports about places you've
                                visited. Help others by providing honest, detailed reviews.
                            </p>
                        </div>
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-card p-6 rounded-xl border border-border text-center shadow-sm">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Stay informed about scams and tourist traps with real-time community
                                alerts.
                            </p>
                        </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                            Reviews are validated by other community members to
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Help make Thailand better for everyone by sharing your experiences and
                            insights
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-card p-8 rounded-xl border border-border shadow-sm">
                            ...
                            <p className="text-muted-foreground mb-4">
                                ...
                                unsafe conditions, or other issues that travelers should know about.
                            </p>
                            <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <section className="bg-linear-to-r from-amber-600 to-orange-600 text-white py-16">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-amber-100 mb-8">
                        Start discovering authentic Thailand with help from our community of honest
                        reviewers.
                    </p>
