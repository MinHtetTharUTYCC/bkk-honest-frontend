        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-amber-100 max-w-3xl mx-auto leading-relaxed">
              Your trusted community-driven platform for honest, authentic
              experiences in Thailand. Discover hidden gems, avoid tourist
              traps, and navigate the country like a local.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Thailand is an incredible country full of amazing experiences,
                but navigating it can be overwhelming. Tourist traps, overpriced
                attractions, and scams can turn a dream trip into a frustrating
                experience.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card p-6 rounded-xl shadow-lg border border-border text-center">
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  Real reviews from real locals and travelers
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-lg border border-border text-center">
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  Stay safe with community-reported alerts
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-lg border border-border text-center">
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  Authentic experiences, no paid promotions
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-lg border border-border text-center">
                ...
                <p className="text-muted-foreground text-sm mt-2">
                  Fresh information you can trust
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Discover spots that only locals know about. From street food
                vendors to hidden temples, find authentic Thailand experiences.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Every review, tip, and recommendation is verified by our
                community. No fake reviews, no paid promotions - just honest
                experiences.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Thailand changes fast. Our community keeps information current,
                so you always have the latest details about places, prices, and
                experiences.
              </p>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Join the BKK Honest Community
          </h2>
          <p className="text-xl text-amber-100 mb-8">
            Help fellow travelers discover the real Thailand. Share your
            experiences, submit reports, and be part of building a more honest
            travel community.
          </p>
