...
import { useDeleteSpot, useSpotBySlug } from '@/hooks/use-api';
...
export default function SpotHeaderClient({
    ...
    return (
        <>
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete the spot and
            ...
            <div className="mt-8">
                <ErrorBoundary name={`${activeTabId}-tab`}>{children}</ErrorBoundary>
            </div>
        </>
    );
}
