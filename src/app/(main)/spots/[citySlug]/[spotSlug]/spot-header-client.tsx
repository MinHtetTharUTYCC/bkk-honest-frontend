...
import {
  useSpotsControllerDelete,
  getSpotsControllerFindBySlugQueryKey,
...
export default function SpotHeaderClient({
  ...
  useState(() => {
    queryClient.setQueryData(
      getSpotsControllerFindBySlugQueryKey(citySlug, spotSlug),
      { data: initialSpot },
    );
  });
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              spot and all associated contributions.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={(e) => {
                ...
                deleteSpotMutation.mutate({
                  id: (spot as SpotWithStatsResponseDto).id,
                });
              }}
